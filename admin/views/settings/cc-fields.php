...
return array(
    ...
    'cc_installment_options' => array(
        ...
        'options' => array(
            ...
            'buyer'  => __( 'Juros por conta do comprador', \RM_PagSeguro\Connect::DOMAIN ),
...
//        'desc_tip' => true,
    ...
    'cc_installments_options_limit_installments' => array(
        'title' => __( 'Limitar parcelas?', \RM_PagSeguro\Connect::DOMAIN ),
        'type'  => 'select',
        'description' => __('Recomendação: Não impeça seu cliente de comprar com um parcelamento elevado mesmo que ele queira assumir os juros.<br/>Não há um custo maior pra você.', \RM_PagSeguro\Connect::DOMAIN),
        'options' => array(
            'no' => __( 'Não (recomendável)', \RM_PagSeguro\Connect::DOMAIN ),
            'yes'  => __( 'Sim', \RM_PagSeguro\Connect::DOMAIN ),
        )
    ),
    
    'cc_installments_options_max_installments' => array(
        'title' => __( 'Número Máximo de Parcelas', \RM_PagSeguro\Connect::DOMAIN ),
        'type'  => 'number',
        'default' => 18,
        'custom_attributes' => array(
            'min' => 1,
