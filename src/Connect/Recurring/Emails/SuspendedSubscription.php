...
if ( ! class_exists( 'SuspendedSubscription', false ) ) :

    /**
     * Suspended Subscription E-mail
     *  An email sent to the customer when a subscription is Suspended.
     *
...
return new SuspendedSubscription();
