...
class Connect
{
    ...
    public static function init()
    {
        ...
        add_action('woocommerce_update_product_variation', [CreditCard::class, 'updateProductInstallmentsTransient'], 10, 2);
        add_action('woocommerce_after_add_to_cart_form', [CreditCard::class, 'getProductInstallments'], 25);
        add_action('rest_api_init', [CreditCard::class,'restApiTableInstallments']);
