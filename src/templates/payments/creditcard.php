...
$installment_options = '<option value="">' . esc_html__( 'Informe um número de cartão', RM_PagSeguro\Connect::DOMAIN ) . '</option>';
$fields = array();
...
$default_fields = [
    ...
    'card-installments' => '<p class="form-row form-row-full">
                    <label for="' . esc_attr( $this->id ) . '-card-installments">' . esc_html__( 'Parcelas', RM_PagSeguro\Connect::DOMAIN ) . '&nbsp;<span class="required">*</span></label>
